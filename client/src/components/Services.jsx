    ...
    return (
        ...
        <hr className="Services-hr"></hr>
            ...
            <div className="flip-card">
                ...
                <img src={bg1} alt="/" style={{width:"19rem",height:"20rem", borderRadius:"18px"}} />
                </div>
        ...
        <div className="flip-card">
            ...
            <div className="flip-card-front">
                ...
                <img src={bg3} alt="/" style={{width:"19rem",height:"20rem", borderRadius:"18px"}} />
        ...
        <hr className="Services-hr" style={{color:"white"}}></hr>
                ...
                <p>You will get notified about new recruiting companies and new notices directly from the Dean Academics and TPO's office.</p>
                <p>through emails</p>
                </div>
                </div>
        </div>
        <div class="flip-card">
            ...
            <div class="flip-card-front">
                {/* <i className="fas fa-clipboard-list fa-10x" style={{color:"#00ba8e"}}></i> */}
                <img src={bg2} alt="/" style={{width:"19rem",height:"20rem", borderRadius:"18px"}} />
